...
<!DOCTYPE html><!-- 현재 문서의 형태를 선언 -->
<html><!-- html문서는 태그열고  ~ 태그닫고 하는 영역확인 중요-->
<head><!-- 문서내용과 관계없는 문서정보가 들어 있고, 메타정보가 존재-->
<meta charset="UTF-8"><!-- 문서의 언어 인코딩 설정. 지금은 유니코드. -->
<!-- 반응형을 작동하기 위해서 사용하는 메타태그 -->
<meta name="viewport" content="width=device-width,initial-scale=1,minimum-scale=1,maximum-scale=1,user-scalable=no">
<title>반응형 홈페이지</title><!-- 문서의 제목을 브라우저 상단 탭창에 표시 -->
<!-- 외부 자바 스크립트 불러오는 태그(아래) -->
...
/* 자바스크립트 시작 */
 $(document).ready(function() {
    	$(".carousel").carousel({
    		  interval: 2000,//화면전환 시간ms
    		  pause: false //마우스 올렸을때 멈추는지
    	})
    });
/* 자바스크립트 끝 */
</script>
...
<!-- 상단 로고와 햄버거 메뉴영역 시작 -->
<h1 class="logo">
<a href="/">LOGO</a><!-- a태그는 페이지 이동역할, href 속성값에 URL을 입력해서 이동 -->
